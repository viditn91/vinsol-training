...
--
-- Host: localhost    Database: libraryHoldings
-- ------------------------------------------------------
...
INSERT INTO `branch` VALUES ('B1','john smith','2 anglesea road'),('B2','mary jones','34 pearse st'),('B3','francis owens','grange x');
...
-- Dump completed on 2013-09-06 10:07:52
